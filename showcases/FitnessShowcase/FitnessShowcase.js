...
function FitnessShowcase() {
  ...
  const renderHome = () => <div className="flex-1 overflow-y-auto scrollbar-hide pb-24 px-5">
      {
    /* Header */
  }
    ...
    /* Activity Rings Alternative (Progress Bars) */
      ...
      <div className="bg-[#1C1C1E] rounded-2xl p-5 mb-6 animate-in fade-in slide-in-from-bottom-4 duration-500 delay-100">
        ...
        <div className="space-y-4">
          {ACTIVITY_STATS.map((stat, i) => <div key={i}>
  ...
  />
    ...
    /* Workouts */
      ...
      <div className="animate-in fade-in slide-in-from-bottom-12 duration-500 delay-300 fill-mode-both text-white">
        ...
        <div className="space-y-4">
          {WORKOUTS.map((workout) => <div key={workout.id} className="relative h-32 rounded-2xl overflow-hidden group cursor-pointer">
  ...
  return <div className="w-full h-full bg-[#09090B] relative flex flex-col overflow-hidden font-sans">
      {activeTab === "home" && renderHome()}
      {activeTab !== "home" && <div className="flex-1 flex items-center justify-center text-gray-500">
          Coming soon
        </div>}
