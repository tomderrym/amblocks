function ElevenLabsLandingShowcase() {
  return <div className="w-full min-h-screen bg-[var(--color-background)] text-[var(--color-foreground)] font-sans theme-elevenlabs">
      {
    /* Navigation */
  }
...
export {
  ElevenLabsLandingShowcase as default
};
