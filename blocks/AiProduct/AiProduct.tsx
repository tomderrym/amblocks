...
export default function aiproduct() {
  return (
    <div className="w-full bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-[#2A2A2A] rounded-xl overflow-hidden mb-2 shadow-sm flex flex-col md:flex-row" style={{ pointerEvents }}>
