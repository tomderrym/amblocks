...
function RegistryExporterShowcase() {
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="mt-8 border-t border-gray-100 dark:border-gray-800 pt-6">
               ...
               <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {filesToExport.map((file) => <div key={file} className="text-xs font-mono bg-gray-50 dark:bg-gray-800/50 px-2 py-1.5 rounded text-gray-600 dark:text-gray-300 truncate">
                      {file}
                    </div>)}
               </div>
            </div>
          ...
          <div className="w-full md:w-80 flex flex-col items-center justify-center p-6 bg-gray-50 dark:bg-black/20 rounded-2xl border border-gray-100 dark:border-gray-800">
            ...
            <div className="text-center mb-6 w-full">
              ...
              {isDownloading && <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5 mt-3 overflow-hidden">
                  <div
  ...
  />
    ...
    className={`w-full py-3 px-4 rounded-xl flex items-center justify-center space-x-2 font-semibold text-white transition-all
                ${isDownloading ? "bg-blue-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/40 active:scale-95"}
              `}
  >
              {isDownloading ? <>
...
export {
  RegistryExporterShowcase as default
};
