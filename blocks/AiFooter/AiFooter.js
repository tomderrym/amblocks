function aifooter() {
  return <div className="w-full bg-gray-50 dark:bg-[#121212] border-t border-gray-200 dark:border-[#2A2A2A] overflow-hidden p-6 mb-2 shadow-sm" style={{ pointerEvents }}>
