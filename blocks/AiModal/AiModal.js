function aimodal() {
  return <div className="w-full bg-gray-900/40 relative h-48 rounded-xl overflow-hidden mb-2 shadow-sm flex items-center justify-center p-4" style={{ pointerEvents }}>
