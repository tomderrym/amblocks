    ...
    <div className="w-full bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-[#2A2A2A] rounded-xl p-4 mb-2 shadow-sm" style={{ pointerEvents }}>
                    ...
                    <div className="relative border-l border-gray-200 dark:border-gray-800 ml-3 space-y-4 pb-2">
                       <div className="relative pl-4">
                          <div className="absolute -left-1.5 top-1.5 w-3 h-3 bg-blue-500 rounded-full border-2 border-white dark:border-[#1A1A1A]"></div>
                       ...
                       <div className="relative pl-4">
                          <div className="absolute -left-1.5 top-1.5 w-3 h-3 bg-gray-300 dark:bg-gray-600 rounded-full border-2 border-white dark:border-[#1A1A1A]"></div>
