  ...
  return (
    <div className="w-full bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-[#2A2A2A] rounded-xl overflow-hidden mb-2 shadow-sm" style={{ pointerEvents }}>
                    ...
                    <div className="flex flex-col">
                       {[1, 2, 3].map(i => (
                         <div key={i} className="px-4 py-2 border-b border-gray-100 dark:border-gray-800/50 flex items-center justify-between last:border-0 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors cursor-pointer">
