...
export default function BackdropShowcase() {
  ...
  return (
    <>
      ...
      />
      {showBackdrop && (
        <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[10000] text-white text-center pointer-events-none">
