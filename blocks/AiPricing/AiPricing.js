function aipricing() {
  return <div className="w-full bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden p-4 mb-2 shadow-sm" style={{ pointerEvents }}>
