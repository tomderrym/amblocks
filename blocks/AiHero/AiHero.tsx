...
export default function aihero() {
  return (
    <div className="w-full bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-[#2A2A2A] rounded-xl overflow-hidden p-6 mb-2 flex flex-col items-center justify-center text-center shadow-sm" style={{ pointerEvents }}>
