...
export default function aicomment() {
  return (
    <div className="w-full bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-[#2A2A2A] rounded-xl p-4 mb-2 shadow-sm space-y-4" style={{ pointerEvents }}>
                    ...
                    <div className="flex gap-2 mt-2 pt-3 border-t border-gray-100 dark:border-[#2A2A2A]">
                       <div className="w-6 h-6 rounded-full bg-gray-200 dark:bg-[#2A2A2A] shrink-0"></div>
