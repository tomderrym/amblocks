function aitooltip() {
  return <div className="w-full bg-white dark:bg-[#1A1A1A] border border-gray-200 dark:border-[#2A2A2A] rounded-xl p-6 mb-2 shadow-sm flex items-center justify-center relative" style={{ pointerEvents }}>
