function aichat() {
  return <div className="w-full bg-gray-50 dark:bg-[#121212] border border-gray-200 dark:border-[#2A2A2A] rounded-xl overflow-hidden p-3 mb-2 shadow-sm flex flex-col gap-3" style={{ pointerEvents }}>
